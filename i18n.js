...
const I18N = {
  ...
  en: {
    ...
    hero_title: "It's okay to feel excited or a little scared. Nuni is here to show you what will happen.",
  ...
  ar: {
    ...
    hero_title: "من الطبيعي أن تشعر بالحماس أو ببعض الخوف. نوني هنا ليريك ما سيحدث.",
  ...
  ru: {
    ...
    hero_title: "Нормально волноваться или немного бояться. Нуни покажет, что будет происходить.",
  ...
  fr: {
    ...
    hero_title: "C’est normal d’être enthousiaste ou d’avoir un peu peur. Nuni est là pour te montrer ce qui va se passer.",
...
const AUDIENCE_I18N = {
  he: {
    ...
    quiz_intro: "עשר שאלות קצרות על ההכנה, ההרדמה וההתאוששות.",
  ...
  en: {
    ...
    audience_little_hero_title: "It's okay to feel excited or a little scared. Nuni is here to show you what will happen.",
    ...
    quiz_intro: "Ten quick questions about preparation, anesthesia and recovery.",
  ...
  ar: {
    ...
    audience_little_hero_title: "من الطبيعي أن تشعر بالحماس أو ببعض الخوف. نوني هنا ليريك ما سيحدث.",
    ...
    quiz_intro: "عشرة أسئلة قصيرة عن الاستعداد والتخدير والتعافي.",
  ...
  ru: {
    ...
    audience_little_hero_title: "Нормально волноваться или немного бояться. Нуни покажет, что будет происходить.",
    ...
    quiz_intro: "Десять коротких вопросов о подготовке, анестезии и восстановлении.",
  ...
  fr: {
    ...
    audience_little_hero_title: "C’est normal d’être enthousiaste ou d’avoir un peu peur. Nuni est là pour te montrer ce qui va se passer.",
    ...
    quiz_intro: "Dix questions rapides sur la préparation, l’anesthésie et le réveil.",
...
const TEEN_QUIZ_I18N = {
  he: [
    ...
    { q: "למה חשוב לספר בכנות על עישון, שימוש בוייפ, אלכוהול או שימוש בחומרים אחרים?", choices: ["כי המידע עשוי להשפיע על הנשימה, התרופות ותוכנית ההרדמה", "רק כדי להשלים טופס מנהלי", "אין לכך משמעות אם אתה צעיר ובריא"], answer: 0, explanation: "המידע עוזר לרופא המרדים לתכנן טיפול בטוח. השאלות נשאלות מסיבות רפואיות בלבד — לא כדי לשפוט אותך." },
  ...
  fr: [
    ...
    { q: "Pourquoi parler honnêtement du tabac, du vapotage, de l’alcool ou d’autres substances ?", choices: ["Cela peut modifier la respiration, les médicaments et le plan d’anesthésie", "Uniquement pour remplir un formulaire administratif", "Cela ne compte pas quand on est jeune et en bonne santé"], answer: 0, explanation: "Ces informations aident l’anesthésiste à préparer des soins plus sûrs. Ces questions sont posées pour des raisons médicales, pas pour te juger." },
