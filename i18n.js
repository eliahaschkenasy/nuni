...
const TEEN_FAQ_I18N = {
  he: {
    ...
    items: [
      ...
      ["איזה מידע חשוב למסור לצוות, גם אם הוא אישי?", "ספר לצוות על תרופות ותוספים, אלרגיות, תגובות קודמות להרדמה, עישון או שימוש בוייפ, אלכוהול ושימוש בחומרים אחרים. המידע עוזר להתאים טיפול בטוח; מטרת השאלות היא רפואית ולא שיפוטית."],
...
const TEEN_QUIZ_I18N = {
  he: [
    ...
    { q: "למה חשוב לספר בכנות על עישון, שימוש בוייפ, אלכוהול או שימוש בחומרים אחרים?", choices: ["כי המידע עשוי להשפיע על הנשימה, התרופות ותוכנית ההרדמה", "רק כדי להשלים טופס מנהלי", "אין לכך משמעות אם אתה צעיר ובריא"], answer: 0, explanation: "המידע עוזר לרופא המרדים לתכנן טיפול בטוח. מטרת השאלות רפואית, לא שיפוטית." },
