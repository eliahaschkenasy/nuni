...
const I18N = {
  ...
  fr: {
    ...
    a1: "Le sommeil est fait pour que l'opération ne fasse pas mal. La préparation peut ressembler à un tout petit pincement ou à une crème fraîche, mais beaucoup d'enfants ne sentent rien du tout.",
    ...
    a3: "En général, un grand peut rester avec toi jusqu'à ce que tu t'endormes, et il sera là quand tu te réveilleras. Demande à l'infirmier ou l'infirmière comment ça se passe dans ton hôpital.",
    q4: "Et si j'ai peur ?",
    a4: "C'est tout à fait normal. Dis-le à un infirmier, une infirmière ou à ton grand — ils peuvent te tenir la main, apporter ton jouet, ou faire la respiration du ballon avec toi.",
    q5: "Est-ce que je vais me sentir mal après ?",
    a5: "Certains enfants se sentent un peu fatigués, un peu étourdis, ou ont un peu mal à la gorge pendant un petit moment. Ça passe, et les infirmiers et infirmières peuvent t'aider à te sentir mieux.",
    ...
    color_juice: "Le jus de pomme", color_mask: "Le masque magique", color_nurse: "L'infirmier gentil",
