...
const I18N = {
  he: {
    ...
    what_p2: "רופא מיוחד שנקרא הרופא המרדימ/ה נותן לך תרופה דרך מסכה רכה שנושמים דרכה, או דרך צינורית דקיקה ביד. ואז לאט־לאט נרדמים, כאילו מרחפים על ענן.",
    what_p3: "בזמן השינה לא מרגישים כלום – לא דקירה ולא כאב. הרופא המרדימ/ה נשאר לידך כל הזמן ומעיר אותך בעדינות כשהניתוח נגמר.",
    ...
    step2_text: "תפגוש/י אחים ואחיות נחמדים ואת הרופא המרדימ/ה. אולי יקשיבו ללב שלך ויבדקו כמה גדלת. אפשר לשאול אותם כל דבר!",
    step3_title: "מתכוננים",
    step3_text: "תלבש/י פיג'מה רכה של בית החולים. לפעמים מורחים קרם קסם על היד כדי שלא תרגיש/י כלום אם מכניסים שם צינורית דקיקה.",
    step4_title: "חדר השינה המיוחד",
    step4_text: "בחדר מיוחד נושמים דרך מסכה רכה שיכולה להריח כמו מסטיק או תות, או מקבלים תרופת שינה דרך הצינורית הדקיקה. אפשר לספור או לנפח בלון גדול מדומיין – ולפני שתסיים/י, כבר תהיה/י ישן/ה.",
    step5_title: "בזמן שאתה ישן",
    step5_text: "לא תרגיש/י ולא תזכור/י את הניתוח. הרופא/ה המרדימ/ה משגיח עליך כל הזמן ודואג שתהיה/י בטוח/ה ונינוח/ה.",
    ...
    a2: "לא. הרופא המרדימ/ה נותן בדיוק את הכמות הנכונה של תרופה ונשאר איתך כל הזמן, כך שתישאר/י ישן/ה עד שהניתוח נגמר.",
    ...
    q6: "כמה זמן זה לוקח?",
    a6: "כל ניתוח שונה. הרופא/ה המרדימ/ה או האחות יכולים לספר לך בערך כמה זמן ייקח שלך. בשבילך זה ירגיש כאילו עצמת עיניים והתעוררת מיד.",
    ...
    tip6: "שאלו שאלות. רשמו כל דבר שאתם לא בטוחים לגביו ושאלו את הרופא המרדימ/ה או הצוות הסיעודי – אין שאלה קטנה מדי.",
    note_title: "חשוב",
