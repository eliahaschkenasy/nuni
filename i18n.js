...
const I18N = {
  he: {
    ...
    a3: "בדרך כלל מבוגר יכול להישאר איתך עד שנרדמים, והוא יהיה שם כשמתעוררים. שאל את האח או האחות מה נהוג בבית החולים שלך.",
    q4: "מה אם אני מפחד?",
    a4: "זה נורמלי לגמרי. ספר לאח, לאחות או למבוגר שלך – הם יכולים להחזיק לך את היד, להביא את הצעצוע שלך, או לנשום איתך נשימת בלון.",
    ...
    color_juice: "כוס מיץ תפוחים", color_mask: "מסכת הקסם", color_nurse: "האח הנחמד",
